		...
		<div class="container-fluid">
			...
			<div class="row">
					...
					<div class="dashbox">
						<div class="dashbox__title">
							...
							<div class="dashbox__wrap">
								<a class="dashbox__refresh" href="#"><i class="fa-solid fa-rotate"></i> </a>
							...
							<table class="dashbox__table">
								...
								<tbody>
									<tr>
										...
										<td>
											<div class="dashbox__table-text dashbox__table-text--rate"><i class="fa-solid fa-star"></i> 9.2</div>
										</td>
									</tr>
									<tr>
										<td>
										...
										<td>
											<div class="dashbox__table-text dashbox__table-text--rate"><i class="fa-solid fa-star"></i> 9.1</div>
										</td>
									</tr>
									<tr>
										<td>
										...
										<td>
											<div class="dashbox__table-text dashbox__table-text--rate"><i class="fa-solid fa-star"></i> 9.0</div>
										</td>
									</tr>
									<tr>
										<td>
										...
										<td>
											<div class="dashbox__table-text dashbox__table-text--rate"><i class="fa-solid fa-star"></i> 8.9</div>
										</td>
									</tr>
									<tr>
										<td>
							...
							<table class="dashbox__table">
								...
								<tbody>
									<tr>
										...
										<td>
											<div class="dashbox__table-text dashbox__table-text--rate"><i class="fa-solid fa-star"></i> 7.2</div>
										</td>
									</tr>
									<tr>
										<td>
										...
										<td>
											<div class="dashbox__table-text dashbox__table-text--rate"><i class="fa-solid fa-star"></i> 6.3</div>
										</td>
									</tr>
									<tr>
										<td>
										...
										<td>
											<div class="dashbox__table-text dashbox__table-text--rate"><i class="fa-solid fa-star"></i> 8.4</div>
										</td>
									</tr>
									<tr>
										<td>
									...
									<tr>
										...
										<td>
											<div class="dashbox__table-text dashbox__table-text--rate"><i class="fa-solid fa-star"></i> 7.7</div>
										</td>
									</tr>
								</tbody>
							</table>
				...
				<div class="col-12 col-xl-6">
					<div class="dashbox">
						<div class="dashbox__title">
							<h3><i class="fa-solid fa-users"></i> Latest users</h3>
				...
				<div class="col-12 col-xl-6">
					<div class="dashbox">
						<div class="dashbox__title">
							<h3><i class="fa-solid fa-star-half-stroke"></i> Latest reviews</h3>
							<div class="dashbox__wrap">
								<a class="dashbox__refresh" href="#"><i class="fa-solid fa-arrows-rotate"></i></a>
