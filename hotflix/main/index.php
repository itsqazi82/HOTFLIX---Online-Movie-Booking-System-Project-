								...
								<!-- <li class="splide__slide">
									<div class="hero__slide" data-bg="img/bg/venom.jpg">
										<div class="hero__content">
											<h2 class="hero__title">Spider-Man 2 Venom<sub class="green">9.8</sub></h2>
								...
								<div class="col-12">
									<div class="filter__content">
										...
										<div class="filter__items">
											<p style="color:white; font-size:30px;">Best movie of 2024</p>
										</div>
										<!-- end filter desk -->
			...
			<div class="row">
				<div class="col-12">
					<div class="footer__content">
						...
						<span class="footer__copyright">© HOTFLIX, 2025 <br> Create by <a href="#Alpha_teams" target="_blank">Alpha Teams</a></span>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal__content">
					<button class="modal__close" type="button" data-bs-dismiss="modal" aria-label="Close"><i class="fa-solid fa-x"></i></button>
					...
					<form action="#" class="modal__form">
						...
						<div class="sign__group">
							...
							<select class="sign__select" name="value" id="value">
								<option value="35">Premium - 1500 RPs</option>
								<option value="50">Cinematic - 3500 RPs</option>
							</select>
